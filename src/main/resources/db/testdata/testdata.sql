...
INSERT INTO recipe
(title, description, portion, preparation, hints, img, date_added, added_by_nickname, added_by_email, non_public)
VALUES ('Krem sułtański',
        'Kultowy deser PRL',
        3,
       ...
       Odkładać na talerz wyłożony ręcznikami papierowymi. Posypać solą morską z młynka. Placki ziemniaczane najlepsze są prosto z patelni gdy są chrupiące.',
        ...
        'anka134@op.pl',
        true),
       ('Kokosowa owsianka z bananami i erytrolem',
        'Szybka kolacja albo pożywne śniadanie',
        2,
        'Płatki owsiane i wiórki kokosowe zalać mlekiem i mleczkiem kokosowym, zagotować. Dodać erytrol, gotować 5 minut.' ||
        ' Na koniec dodać pokrojonego w plastry dorzałego banana.',
        'brak',
        'owsianka-banan.jpg',
        '2024-04-09 19:47:16',
        'AnkaZ',
...
VALUES (1L, 1L, '500 ml'),
       ...
       (13L, 3L, '1 szklanka'),
       (14L, 3L, '3 łyżki'),
       (15L, 3L, '1 mały kartonik'),
       (16L, 3L, '1 szklanka'),
       (17L, 3L, '1 dojrzała sztuka'),
       (18L, 3L, '1 łyżka');

INSERT INTO category
    (name, description, img, url)
VALUES ('NA SŁODKO', 'Pyszne, tradycyjne ciasta i desery dla łasuchów.', 'na-slodko.jpg', 'na-slodko'),
...
VALUES ('Jan', 'Kowalski', '1994-12-11', 'AdminJanek', 'admin@wp.pl', '{noop}hard', false),
       ('Anna', 'Zawadzka', '2023-12-07', 'AnkaZ', 'anka134@op.pl', '{noop}anka123', true),
       ('Mikołaj', 'Grudzień', '1971-10-19', 'gwiazdorek71', 'gwiazdoooor@swiety.com',
        '{bcrypt}$2a$10$4dWIrzbYv7vBk9NmV2wtR.dLD/UuzOeeBU0jVc/3Ch/X5xsV.LACW', false);
